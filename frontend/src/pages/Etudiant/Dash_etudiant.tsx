    ...
    <div className="row g-4">
      ...
      <div className="col-12">
        <div className="card card-custom p-4">
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <span className="fw-semibold">{stats_etude.progress}%</span>
          </div>
          ...
          <div className="progress mb-2" style={{ height: "10px" }}>
            <div
              ...
              role="progressbar"
              style={{ width: `${stats_etude.progress}%` }}
              aria-valuenow={stats_etude.progress}
              aria-valuemin={0}
              aria-valuemax={100}
            />
          </div>
      ...
      <div className="col-md-4">
        <div className="card card-custom text-center p-4">
          ...
          <h3 className="fw-bold">{stats_etude.coursesCompleted}</h3>
      ...
      <div className="col-md-4">
        <div className="card card-custom text-center p-4">
          ...
          <h3 className="fw-bold">{stats_etude.exercisesCompleted}</h3>
      ...
      <div className="col-md-4">
        <div className="card card-custom text-center p-4">
          ...
          <h3 className="fw-bold">{stats_etude.weeklyTime}</h3>
