    ...
    <div className="row g-4">
      ...
      <div className="col-12">
        <div className="card card-custom p-4">
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <span className="fw-semibold">{stats_data.progress}%</span>
          </div>
          ...
          <div className="progress mb-2" style={{ height: "10px" }}>
            <div
              ...
              role="progressbar"
              style={{ width: `${stats_data.progress}%` }}
              aria-valuenow={stats_data.progress}
              aria-valuemin={0}
              aria-valuemax={100}
            />
          </div>
      ...
      <div className="col-md-4">
        <div className="card card-custom text-center p-4">
          ...
          <h3 className="fw-bold">{stats_data.coursesCompleted}</h3>
      ...
      <div className="col-md-4">
        <div className="card card-custom text-center p-4">
          ...
          <h3 className="fw-bold">{stats_data.exercisesCompleted}</h3>
      ...
      <div className="col-md-4">
        <div className="card card-custom text-center p-4">
          ...
          <h3 className="fw-bold">{stats_data.weeklyTime}</h3>
